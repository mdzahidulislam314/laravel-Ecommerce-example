  ...
  BFHNumber.prototype = {
    ...
    initInput: function() {
      ...
      if (this.options.buttons === true) {
        ...
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn inc"><span class="ion-chevron-up"></span></span>');
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn dec"><span class="ion-chevron-down"></span></span>');
      }
